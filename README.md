...
so that during OLLIR generation it can be checked if while loops can be promoted to do-whiles, avoiding the
need of an extra goto instruction and label.
...
whileBody1:
    ...
    if (i.i32 <.bool 10.i32) goto whileBody1;
```
...
Special care was taken in order for the added temporary variables do not conflict with the user
defined variables.
